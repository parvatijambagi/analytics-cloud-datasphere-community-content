...
Delete any older **Planning Table** widget first, then upload JSON + ZIP. After install the toolbar must show **v1.3.37**. Table Type lives in **Styling** (not a custom Builder). `main.js` and `styling.js` in this folder are source copies for inspection.
