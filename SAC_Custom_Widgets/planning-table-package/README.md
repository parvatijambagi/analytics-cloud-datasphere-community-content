...
Delete any older **Planning Table** widget first, then upload JSON + ZIP. After install the toolbar must show **v1.3.2**. `main.js` and `styling.js` in this folder are source copies for inspection.
